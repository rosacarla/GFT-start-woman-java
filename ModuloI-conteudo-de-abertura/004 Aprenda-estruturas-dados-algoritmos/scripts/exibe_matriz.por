...
programa
{
	...
	funcao inicio()
	{
		...
		const inteiro TAMANHO = 5  //define a constante tamanho

		// Cria a matriz
		inteiro matriz[TAMANHO][TAMANHO] 

		para (inteiro linha = 0; linha < TAMANHO; linha++) //para percorre a linha
		{
			para (inteiro coluna = 0; coluna < TAMANHO; coluna++) //para percorre a coluna
			{
