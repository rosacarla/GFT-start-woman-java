...
Após determine o menor nro da matriz e sua posição(linha, coluna).
*/
public class ArrayMultidimensional {
    public static void main(String[] args) {
        ...
        //para: variável i = 0, até i menor que o tamanho da matriz (array multidimensional), acrescentamos 1 ao valor de i a cada loop.
        for (int i = 0; i < M.length; i++) { //navegando na matriz; i é linha e j pe coluna
            ...
            for (int j = 0; j < M[i].length; j++) { //navegando na linha (array unidimensional)
                M[i][j] = random.nextInt(9); //atribuindo um número aleatoriamente à posição do elemento

                //se o elemento em determinada posição (linha e coluna) é menor que o menor número
                if (M[i][j] < menor) {
