...
public class OrdemInversa {
    public static void main(String[] args) {
        int[] vetor = {5, 8, 9, 6, 11, -1}; //inicializado vetor unidimensional com 5 elementos.
        //vetor com posiçoes de 0 a 5 e composto por 6 elementos
        int count = (vetor.length - 1); //o contador deverá ser um nro menor que o tamanho do vetor.
        System.out.print("Vetor Inverso: "); //Frase ilustrativa
        //loop
        while (count >= 0) { //enquanto o contador tiver o valor maior ou igual 0
            System.out.print(vetor[count] + " "); //imprima valor do elemento do vetor na posição indicada pelo contador.
