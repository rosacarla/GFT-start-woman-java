...
um nro inteiro fornecido pelo usuário.
Ex.: 5!=5.4.3.2.1=120
*/
...
public class Fatorial {
    public static void main(String[] args) {
        ...
        //para: variável i = numero, até i maior que 0, diminuimos 1 do valor de i a cada loop.
        for(int i = numero; i > 0; i--) {
            multiplicacao *= i; //multiplicamos os valores de i e armazenamos na variável multiplicacao

            //criamos estrutura condicional para imprimir o resultado conforme solicitado no exercício.
