 ...
 * 	informado. 
 * 	
 * 	Por último, o programa exibe uma mensagem informando se o valor informado foi encontrado 
...
programa
{
	...
	{ 
		...
		{
			se (vetor[posicao] == numero)  //condição verdadeira quando encontra
			{
		...
		se (nao achou)   //condição falsa quando nao encontra
		{
